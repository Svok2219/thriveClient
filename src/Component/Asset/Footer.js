...
const HeroFooter = () => {
  return (
    <footer class="text-center text-lg-start bg-light text-muted">
      <section
        style={{ backgroundColor: "rgba(34, 110, 147, 1)" }}
        class="d-block d-md-flex justify-content-center justify-content-lg-between border-bottom px-5"
      >
        <div class="text-light p-4">
          Powered by @thriverswagmi.com | An @yesiamjc venture
        </div>

        <div className="mt-md-3 mb-1">
